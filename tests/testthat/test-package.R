test_that("all input data have been coerced to correct type", {
  expect_s3_class(json_to_paramter_list(test_path('testdata', 'preferred.json')), 'list')
  expect_s3_class(json_to_paramter_list(test_path('testdata', 'consts.json')), 'list')
})

test_that("calibratable parameters are correctly loaded", {
  x <- json_to_paramter_list(test_path('testdata', 'preferred.json'))
...
test_that("constant parameters are correctly loaded", {
  x <- json_to_paramter_list(test_path('testdata', 'consts.json'))
...
test_that("estimate_sgd() returns correct type", {
  ...
  calibratableParamsList <- json_to_paramter_list(test_path('testdata', 'preferred.json'))
  constParamsList <- json_to_paramter_list(test_path('testdata', 'consts.json'))
