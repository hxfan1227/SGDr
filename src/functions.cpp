...
//' @export 
// [[Rcpp::export]]
Rcpp::List estimate_sgd(const Rcpp::DataFrame& inputData, const Rcpp::List& calibratableParams, const Rcpp::List& constParams, int nw = 120, int warmp = 1500)
{
    Model model(inputData, calibratableParams, constParams, warmp);
    model.run(nw, warmp);
